...
select *, 'Billed' as billing from staging.mmgmt m union all select *, 'Billed' as billing from staging.obrm o 
)	
...
select 
	...
	a.region,
	a.data_source,
	/*Below are 5 new added columns --> dur_range, hr_id, state_id, dur_range_id & billing*/
	case 
...
/*
select distinct data_source, billing from data.billed
-------------------
data_source	billing
-------------------
CYN_BRM		Billed
